...
@Component
@Transactional
public class BlackListToBatchTransfer extends AbstractTransfer<BlacklistNode, BatchNode, BlackListToBatchData>{

	@Override
	public TransferResult transfer(BlacklistNode fromNode, BatchNode toNode,
			BlackListToBatchData transferData) {
		int count = 0;
