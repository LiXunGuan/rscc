...
@Component
@Transactional
public class IntentToCustomerTransfer extends AbstractTransfer<IntentNode, CustomerNode, IntentToCustomerData> {

	@Override
	public TransferResult transfer(IntentNode fromNode, CustomerNode toNode, IntentToCustomerData transferData) {
