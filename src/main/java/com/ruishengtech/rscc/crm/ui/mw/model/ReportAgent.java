 ...
 */
@Table(name = "mw.report_agent")
public class ReportAgent extends CommonDbBean {
     ...
     */
    @Column(meta = "INT")
    private Integer in_f_ringduration=0;

    /**
     * 呼入振铃时长（接通）
     */
    @Column(meta = "INT")
    private Integer in_t_ringduration=0;
  ...
  //导出数据用，组织时间格式
	...
	public Integer getIn_f_ringduration() {
		return in_f_ringduration;
	}

	public void setIn_f_ringduration(Integer in_f_ringduration) {
		this.in_f_ringduration = in_f_ringduration;
	}

	public Integer getIn_t_ringduration() {
		return in_t_ringduration;
	}

	public void setIn_t_ringduration(Integer in_t_ringduration) {
		this.in_t_ringduration = in_t_ringduration;
	}
