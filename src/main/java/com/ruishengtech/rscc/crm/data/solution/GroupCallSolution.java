...
public class GroupCallSolution implements ISolution{

	private GroupCallCondition groupCallCondition ;
	...
	public void getWhere(ICondition condition, StringBuilder whereSql,
		...
		groupCallCondition = (GroupCallCondition) condition;
		whereSql.append("From data_group_call t ").append(" WHERE 1=1 ");
