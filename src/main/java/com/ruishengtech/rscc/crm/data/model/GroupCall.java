 ...
 *
 */
@Table(name = "data_group_call")
public class GroupCall extends CommonDbBean { 
	...
	//双方接通
	public static final String stat_answered = "3";
	
	//单方接通
	public static final String stat_single_answered = "4";
    ...
    @NColumn(meta = "VARCHAR(100)", column = "data_src_url")
    private String data_src_url;
    
    //中间件向此URL返回呼叫结果
    @NColumn(meta = "VARCHAR(100)", column = "data_dst_url")
