...
$.extend( true, $.fn.dataTable.defaults, {
	"sDom" :"t" + "<'dt-toolbar-footer'<'col-sm-6 col-xs-12'i><'col-xs-12 col-sm-6 text-right'lp>>",
        ...
        "fnInit": function( oSettings, nPaging, fnDraw ) {
            ...
            $(nPaging).addClass('pagination').append(
                '<ul class="pagination pagination-sm">'+
	                ...
	                '&nbsp;&nbsp;跳转至&nbsp;<input type="text" style="width: 30px;padding-top: 5px;padding-bottom: 5px;height: 13px;box-sizing: content-box;" id="redirect" class="redirect">&nbsp;页&nbsp;&nbsp;'+
//	                '&nbsp;&nbsp;跳转至&nbsp;<select id="redirect"></select>&nbsp;页&nbsp;&nbsp;'+
                '</ul>'
                );
 
            //datatables分页跳转
            $(nPaging).find(".redirect").on("change",function(e){
