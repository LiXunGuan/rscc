...
$.fn.dataTableExt.oPagination.extStyle = {
    ...
    "fnInit": function (oSettings, nPaging, fnCallbackDraw) {
        ...
        nFirst = $('<span/>', { 'class': 'paginate_button first' , text : "首页" });
        nPrevious = $('<span/>', { 'class': 'paginate_button previous' , text : "上一页" });
        nNext = $('<span/>', { 'class': 'paginate_button next' , text : "下一页" });
        nLast = $('<span/>', { 'class': 'paginate_button last' , text : "尾页" });
