<div class="modal fade" id="dialog_getBlackListCount">
	<div class="modal-dialog" style="width: 90%;">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title">成交客户量数据查看</h4>
			</div>
	...
	<!-- 									<div class="widget-body-toolbar"></div> -->
										...
										<table id="dt_basic_getCustomercount" class="table table-bordered table-hover"></table>
									</div>
								</div>
							</div>
						</article>
...
<script src="${springMacroRequestContext.contextPath}/public/js/databatch/getCustomerCount.js"></script>
