    ...
    <div class="modal-dialog" style="width: 600px;">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">配额批量设置</h4>
            </div>
            <div class="modal-body">
                <form action="${springMacroRequestContext.contextPath}/userManage/batChangeSubmit" class="smart-form" id="changeLimitForm" method="post">
                	<fieldset style="padding-top: 2px;">
<!--                 		<section> -->
<!-- 	                		<div class="row"> -->
<!-- 		                    	<label class="label col col-3"> 请选择修改类型： </label> -->
<!-- 								<label class="input col col-6"  style="display: flex;" id="defaultdata"> -->
<!-- 									<label class="radio col-5" > -->
<!-- 										<input type="radio" name="batchangedata" value="default" checked="checked"> -->
<!-- 									<i></i>修改默认上限值</label> -->
<!-- 									<label class="radio col-5"> -->
<!-- 										<input type="radio" name="batchangedata" value="all"> -->
<!-- 									<i></i>修改全部上限值</label> -->
<!-- 								</label> -->
<!-- 							</div> -->
<!-- 						</section> -->
            ...
            <div class="modal-footer">
                ...
                <button type="button" id="batchangesave" class="btn btn-primary">保存 </button>
            </div>
        </div>
    </div>
</div>
