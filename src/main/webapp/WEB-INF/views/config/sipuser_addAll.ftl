<div class="modal fade" id="sipuserAddAllSaveModel" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="${springMacroRequestContext.contextPath}/config/sipuser/saveAll" class="smart-form"
                      id="coreForm">
                   <input type="hidden" id="pwdType" name="pwdType" value=""/>
                    ...
                    <section>
                    	...
                    	<div class="row">
                    		...
                    		<input type="radio" name="chkPwd" onclick="pwdSty();" value="1" checked="checked"/>与分机号码一致
                    	</div>
                    	<div class="row">
                    		<label class="label col col-2"></label>
                    		 <input type="radio" name="chkPwd" onclick="pwdSty();" value="2" />随机生成6位数字
                    	</div>
                    	<div class="row">
                    		<label class="label col col-2"></label>
                    		 <input type="radio" name="chkPwd" onclick="pwdSty();" value="3" />使用统一密码
                    ...
                    <section>
                        <div class="row">
                            ...
                            <input id="area_code" onfocus="onfocus" name="area_code" value="" />
                        </label>
                        </div>
                    </section>
                    <section>
                    ...
                    <section>
                        <div class="row">
                            <label class="label col col-2">显示号码</label> <label
                                class="input col col-8">
                            <input id="caller_id_number" onfocus="onfocus" name="caller_id_number" value="" />
                        </label>
                        </div>
                    </section>
                    ...
                    <section>
                        <div class="row">
                            <label class="label col col-2">显示名称</label> <label
                                class="input col col-8">
                            <input id="caller_id_name" onfocus="onfocus" name="caller_id_name" value="" />
                        </label>
                        </div>
                    </section>
	            </div>
...
<script type="application/javascript">
    ...
    $('#sipuserAddAllSaveModel').modal("show");
    
    $('#sipuserAddAllSaveModel').on('hide.bs.modal', function(e){
		$("#sipuserAddAllSaveModel").remove();
	});
    ...
    $('#coreForm').ajaxForm({
        ...
        success: function (data) {
            $("#sipuserAddAllSaveModel").modal("hide");
            if (data.success) {
                $.smallBox({
                    title: "操作成功",
