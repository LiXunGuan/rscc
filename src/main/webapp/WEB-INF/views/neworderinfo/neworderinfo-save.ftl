...
<!-- 	<script src="${springMacroRequestContext.contextPath}/assets/js/plugin/jquery-nestable/jquery.nestable.min.js"></script> -->
		...
		<#if maps??>
			...
			<#list maps?keys as key>
				...
				<#if (maps[key].columnNameDB) == "receive_user_name" || (maps[key].columnNameDB) == "receive_user_address" || (maps[key].columnNameDB) == "receive_user_mobile" >
					...
					<#elseif (maps[key].columnNameDB) == "receive_user_mobile">
						<div class="form-group">
							<label class="col-md-2 control-label">${maps[key].columnName}</label>
							<div class="col-md-5">
								<input class="form-control ${requireds}" placeholder="${maps[key].columnName}" id="${(maps[key].columnNameDB)!''}" type="text">
							</div>
						</div>
					<#else>
						<div class="form-group">
	        ...
	        <div class="modal-content" >
	            ...
	            <div class="modal-body" >
		                        ...
		                        <section>
		                            <div class="row">
		                                ...
		                                <div class="rating col col-6" style="text-align: left;">
		                                    <input name="score" id="score" value="${sScore!''}"/>
	                ...
	                <form id="orderInfos" action="${springMacroRequestContext.contextPath}/neworderinfo/save" class="form-horizontal" method="post">
						...
						<input type="hidden" name="receive_user_mobile" id="receive_user_mobile_hidden" >
						<input type="hidden" name="call_session_uuid" id="call_session_uuid_order" value="${call_session_uuid!''}">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function(){
            ...
            // 显示电话号码
            if($("#phone_number_a").length != 0){
	            $("#receive_user_mobile").val(window.parent.hiddenPhone($("#phone_number_a").val()));
	            $("#receive_user_mobile_hidden").val($("#phone_number_a").val());
            }
            
            if($("#call_session_uuid").length != 0 && $("#call_session_uuid").val() != '' && $("#call_session_uuid_order").val() == ''){
            	$("#call_session_uuid_order").val($("#call_session_uuid").val());
            }
...
//                 		$(this).find("[name = 'pSumCount']").val("总数量：" + parseInt(psumcount) + "/件");
				...
				$("#receive_user_mobile_hidden").val($("#receive_user_mobile").val());
			</#if>
...
//                 		mobile : [] 
            ...
            $('#msubmit').click(function(){
            	...
            	<#else>
            		...
            		if($("#receive_user_mobile_hidden").val() == ''){
            			$("#receive_user_mobile_hidden").val($("#receive_user_mobile").val());
            		}
