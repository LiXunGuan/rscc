...
<div class="modal fade" id="dialogTask">
	<div class="modal-dialog" style="width: 40%">
		<div class="modal-content">
            ...
            <div role="content">
	            <div class="row">
		            <form id="project-wizard" action="${springMacroRequestContext.contextPath}/data/groupCall/wizard" class="form-horizontal" novalidate="novalidate" method="post">
...
<!-- 											</div> -->
								...
								<div class="tab-pane" id="tab2">
									...
									<select multiple="multiple" id="dataDuallistbox" class="form-control" name="datas">
										<#list datas as d>
										<#if !(addedbyothers?seq_contains(d.dataTable))>
