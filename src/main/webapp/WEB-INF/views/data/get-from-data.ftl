    ...
    <div class="modal-dialog" style="width: 600px">
        <div class="modal-content" >
            ...
            <div class="modal-body">
                <form id="messageinfoa" action="${springMacroRequestContext.contextPath}/data/project/getdata" class="smart-form" method="post">
                    <header>
...
<!-- 							</div> -->
						...
						<div>
							...
							<#list datas as d>
								<option value=${d.dataTable} data-count=${d.dataCount}>${d.containerName} [已分配/总量：${d.allocateCount}/${d.dataCount}]</option>
							</#list>
							</select>
						</div>
					</div>
