    ...
    <div class="modal-dialog" style="width: 700px">
        <div class="modal-content" >
            ...
            <div class="modal-body">
                <form id="messageinfoa" action="${springMacroRequestContext.contextPath}/data/data/collectionData" class="smart-form" method="post">
                <header>
...
<!-- 									<div class="col col-4" id="allocateMax" style="padding-left:0px"> -->
<!-- 										<label class="input"> -->
...
<!-- 									</div> -->
<!-- 								</div> -->
<!-- 						<div class="col col-5" id="dataMax" style="padding-left:0px"> -->
<!-- 							<label class="input"> -->
<!-- 								<span class="icon-append">条</span> -->
<!-- 								<input type="text" name="dataMax"> -->
<!-- 							</label> -->
<!-- 						</div> -->
					</section>
<!-- 				</fieldset> -->
<!-- 				<fieldset> -->
                    <div>
						...
						<#list allocateUsers?values as u>
							<option value=${u.uid} >[${u.department}] ${u.projectName} [未完成/总量：${u.dataCount-u.userCount}/${u.dataCount}]</option>
						</#list>
						</select>
					</div>
				</fieldset>
