    ...
    <div class="modal-dialog" style="width: 600px">
        <div class="modal-content" >
            ...
            <div class="modal-body">
                <form id="messageinfoa" action="${springMacroRequestContext.contextPath}/data/project/revertdata" class="smart-form" method="post">
                    <header>
                	当前人员:${entry.projectName}，共有数据${entry.dataCount}条，未完成${entry.dataCount-entry.userCount}条
					</header>
					<fieldset>
					<div>
...
<!-- 							</div> -->
							<div class="row">
								<div class="col">
									<label class="radio">
										<input type="radio" class="radiobox style-0" name="revertData" value="0" checked="checked" >
										<span>归还未完成数据</span> 
									</label>
								</div>
							</div>
							<div class="row">
								<div class="col">
									<label class="radio">
										<input type="radio" class="radiobox style-0" name="revertData" value="1">
										<span>归还已完成数据</span> 
									</label>
								</div>
							</div>
							<div class="row">
								<div class="col">
									<label class="radio">
										<input type="radio" class="radiobox style-0" name="revertData" value="2">
										<span>归还全部数据</span> 
									</label>
								</div>
							</div>
...
<!-- 							</div> -->
						...
						<div>
							...
							<#list datas?values as d>
								<option value=${d.dataTable} data-count=${d.dataCount}>${d.containerName} [未完成/总量：${d.allocateCount}/${d.dataCount}]</option>
							</#list>
							</select>
						</div>
					</div>
