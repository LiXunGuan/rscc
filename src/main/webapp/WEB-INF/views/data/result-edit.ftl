...
<div class="modal fade" id="dialog_cstm_tags">
    <div class="modal-dialog" style="width: 40%;">
        <div class="modal-content" >
            ...
            <div class="modal-body"  >
                ...
                <form id="taskInfo" action="${springMacroRequestContext.contextPath}/data/result/addResult" class="smart-form" method="post">
                    <fieldset>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function(){
            ...
            $('#call_times_b').attr("readonly","readonly").val(Number($('#call_times_b').val())+1);
            /** 校验字段  **/
