...
<section id="widget-grid-reportagenttraffic">
	<div class="row">
			...
			<div class="jarviswidget jarviswidget-color-blueDark" id="wid-id-3"
				...
				<div>
					...
					<div class="widget-body no-padding">
						...
						<table id="reportagenttrafficTable"
	...
	<div id="reportagenttrafficforModel"></div>
</section>
...
//         gettitleshow();
    ...
    function gettitleshow(){
    	var url=getContext() + "report/reportagenttraffic/menushow"
...
//     	var tab = $('#reportagenttrafficTable').DataTable();
...
//     		column.visible(true);
    ...
    function initTable(){
        ...
        oTable = $('#reportagenttrafficTable').dataTable({
		    ...
		    "ajax":{
		    	"url" : getContext() + "report/reportagenttraffic/data",
		    	"type":"POST",
		    	"data" :function(param){
			...
			"columns" : [
				   ...
				   { "title" : "呼入平均振铃（未通）", "data" : "in_f_ringduration"},
				   { "title" : "呼入平均振铃（接通）", "data" : "in_t_ringduration"},
				   { "title" : "呼出平均时长", "data" : "outtavg"},
				   { "title" : "呼入平均时长", "data" : "intavg"}
			],
		});
    ...
    $("#export").click(function(){
		...
		var url = getContext()+"report/reportagenttraffic/export?";
    	var selectionReport = $("#selectionReport").val();
