...
<style>
#dialogBatAdd div.col label.input input
{
	height:25px;
}
...
#dialogBatAdd .note.note-error
{
	display:none;
}
</style>
<div class="modal fade" id="dialogBatAdd">
...
<!-- 					<section> -->
<!-- 						<div class="row"> -->
<!-- 							<label class="label col col-3 ">工号</label> -->
<!-- 							<div class="input col col-8"> -->
<!-- 								<input name="jobNumber" value=""> -->
<!-- 							</div> -->
<!-- 						</div> -->
<!-- 					</section> -->
<!-- 					<section> -->
<!-- 						<div class="row"> -->
<!-- 							<label class="label col col-3 ">呼叫名</label> -->
<!-- 							<div class="input col col-8"> -->
<!-- 								<input name="callerIdName" value=""> -->
<!-- 							</div> -->
<!-- 						</div> -->
<!-- 					</section> -->
<!-- 					<section> -->
<!-- 						<div class="row"> -->
<!-- 							<label class="label col col-3 ">呼叫号</label> -->
<!-- 							<div class="input col col-8"> -->
<!-- 								<input name="callerIdNumber" value=""> -->
<!-- 							</div> -->
<!-- 						</div> -->
<!-- 					</section> -->
					<section>
	...
	<script type="text/javascript">
        $(document).ready(function(){
            ...
            /* 禁用空白自动关闭*/
            $('#dialogBatAdd').modal({backdrop: 'static'});
            
            /*添加正整数自定义jquery校验，用于校验起始和结束号码的类型*/
            ...
            /* 关闭窗口的回调函数  */
            $('#dialogBatAdd').on('hide.bs.modal', function (e) {   /* hide 是关闭调用后在关闭;hidden 是关闭后在调用； */
    			$("#dialogBatAdd").remove();
    		});
...
//     	$("#department").val("01").trigger("change");
